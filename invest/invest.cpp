...
double balanceAt10thYear2 (double initialInvestment)
{
	// initial interest is 2.0%
	// at the 10th year, interest reduces to 1.0%
	// each year the interest reduces by 1.0%/9
 ...
 */
	...
	{
		balance = balance * (1.0 + interestRate); // This is the formula to compound the interest to the balance 
		interestRate = interestRate - 0.01/9.0;	// Adjusts the interest rate by end of the year 
...
{
	cout.precision(9);
	cout << "For the $10,000 initial investment the final balance at end of the 10th year is $" << balanceAt10thYear(10000.00) << " ." << endl;
//	cout << "For the $10,000 initial investment the final balance at end of the 10th year is $" << balanceAt10thYear2(10000.00) << " ." << endl; // Either formula can be called
